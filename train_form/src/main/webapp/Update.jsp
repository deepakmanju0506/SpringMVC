    ...
    <div class="container">
        <form action="updateTicket" method="post">
            ...
            <div class="form-group">
                <input type="text" name="source" class="form-control" placeholder="SELECT YOUR SOURCE" value=${value.source}>
            ...
            <div class="form-group">
                <input type="number" name="noOfMembers" class="form-control" placeholder="NUMBER OF MEMBERS" value=${value.noOfMembers}>
